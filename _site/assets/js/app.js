...
var _reactFastclick = __webpack_require__(10);

var _reactFastclick2 = _interopRequireDefault(_reactFastclick);

var _typewriter = __webpack_require__(16);
...
window.onload = function () {
  ...
  if (f) (0, _typewriter2.default)(['NASA astronauts', 'Indigenous water and land activists', 'Sustainable space technology researchers', 'Responsible clothing manufacturers', 'Cultural influencers', 'Soil and compost advocates', 'Industrial textile recyclers', 'Blockchain and technology experts', 'Leaders in the fashion space', 'Global brands', 'Supply chain experts', 'Underground streetwear icons', 'Advanced new material scientists'], f);
}; // index
...
exports.default = function (sayings, element) {
  ...
  function type(text, letter_counter, word_counter) {
    ...
    if (last_counter) setTimeout(type, 40, text, letter_counter + 1, word_counter);else setTimeout(init, 800, word_counter + 1);
  }
};
